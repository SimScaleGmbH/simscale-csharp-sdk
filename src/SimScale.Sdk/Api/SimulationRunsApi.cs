...
namespace SimScale.Sdk.Api
{
    ...
    public interface ISimulationRunsApiSync : IApiAccessor
    {
        ...
        /// <param name="simulationId">The simulation ID</param>
        /// <param name="runId">The simulation run ID</param>
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>SimulationSpec</returns>
        SimulationSpec GetSimulationRunSpec (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        ...
        ApiResponse<SimulationSpec> GetSimulationRunSpecWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        /// <summary>
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>SimulationSpec</returns>
        SimulationSpec GetSimulationRunSubRunSpec (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>ApiResponse of SimulationSpec</returns>
        ApiResponse<SimulationSpec> GetSimulationRunSubRunSpecWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        /// <summary>
    ...
    public interface ISimulationRunsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SimulationSpec> GetSimulationRunSpecAsync (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        ...
        System.Threading.Tasks.Task<ApiResponse<SimulationSpec>> GetSimulationRunSpecAsyncWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        /// <summary>
        /// Get the simulation sub-run results
        /// </summary>
        /// <remarks>
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>Task of SimulationSpec</returns>
        System.Threading.Tasks.Task<SimulationSpec> GetSimulationRunSubRunSpecAsync (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>Task of ApiResponse (SimulationSpec)</returns>
        System.Threading.Tasks.Task<ApiResponse<SimulationSpec>> GetSimulationRunSubRunSpecAsyncWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0");
        /// <summary>
        /// List of sub-runs of parametric runs
        /// </summary>
        /// <remarks>
    ...
    public partial class SimulationRunsApi : ISimulationRunsApi
    {
        ...
        /// <summary>
        /// Create a simulation run This operation creates a run in status &#x60;READY&#x60;, however the run is not automatically started. The run must be started explicitly using the &#x60;POST /projects/{projectId}/simulations/{simulationId}/runs/{runId}/start&#x60; endpoint. 
        /// </summary>
        /// <exception cref="SimScale.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">The project ID</param>
        /// <param name="simulationId">The simulation ID</param>
        ...
        /// <summary>
        /// Get Python SDK code for the simulation run Important: due to incompatibilities between the source Spec version and the target SDK version the generated code may contain incomplete sections or even be invalid. The generated code is provided as a convenience and should be reviewed and adapted before use.
        /// </summary>
        /// <exception cref="SimScale.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">The project ID</param>
        /// <param name="simulationId">The simulation ID</param>
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>SimulationSpec</returns>
        public SimulationSpec GetSimulationRunSpec (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>ApiResponse of SimulationSpec</returns>
        public SimScale.Sdk.Client.ApiResponse< SimulationSpec > GetSimulationRunSpecWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>Task of SimulationSpec</returns>
        public async System.Threading.Tasks.Task<SimulationSpec> GetSimulationRunSpecAsync (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>Task of ApiResponse (SimulationSpec)</returns>
        public async System.Threading.Tasks.Task<SimScale.Sdk.Client.ApiResponse<SimulationSpec>> GetSimulationRunSpecAsyncWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new SimScale.Sdk.Client.ApiException(400, "Missing required parameter 'projectId' when calling SimulationRunsApi->GetSimulationRunSpec");
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>SimulationSpec</returns>
        public SimulationSpec GetSimulationRunSubRunSpec (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>ApiResponse of SimulationSpec</returns>
        public SimScale.Sdk.Client.ApiResponse< SimulationSpec > GetSimulationRunSubRunSpecWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>Task of SimulationSpec</returns>
        public async System.Threading.Tasks.Task<SimulationSpec> GetSimulationRunSubRunSpecAsync (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to. This can be either the external version like &#x60;30.0&#x60;, or the internal version like &#x60;internal:549&#x60;. (optional, default to &quot;32.0&quot;)</param>
        /// <returns>Task of ApiResponse (SimulationSpec)</returns>
        public async System.Threading.Tasks.Task<SimScale.Sdk.Client.ApiResponse<SimulationSpec>> GetSimulationRunSubRunSpecAsyncWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), Guid? runId = default(Guid?), Guid? subRunId = default(Guid?), string simulationSpecSchemaVersion = "32.0")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new SimScale.Sdk.Client.ApiException(400, "Missing required parameter 'projectId' when calling SimulationRunsApi->GetSimulationRunSubRunSpec");
