...
namespace SimScale.Sdk.Api
{
    ...
    public interface IMeshOperationsApiSync : IApiAccessor
    {
        ...
        /// <returns>MeshOperation</returns>
        MeshOperation GetMeshOperation (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3");
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>ApiResponse of MeshOperation</returns>
        ApiResponse<MeshOperation> GetMeshOperationWithHttpInfo (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3");
        /// <summary>
    ...
    public interface IMeshOperationsApiAsync : IApiAccessor
    {
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>Task of MeshOperation</returns>
        System.Threading.Tasks.Task<MeshOperation> GetMeshOperationAsync (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3");
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>Task of ApiResponse (MeshOperation)</returns>
        System.Threading.Tasks.Task<ApiResponse<MeshOperation>> GetMeshOperationAsyncWithHttpInfo (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3");
        /// <summary>
        /// Get the mesh operation event log
        /// </summary>
        /// <remarks>
    ...
    public partial class MeshOperationsApi : IMeshOperationsApi
    {
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>MeshOperation</returns>
        public MeshOperation GetMeshOperation (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3")
        {
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>ApiResponse of MeshOperation</returns>
        public SimScale.Sdk.Client.ApiResponse< MeshOperation > GetMeshOperationWithHttpInfo (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>Task of MeshOperation</returns>
        public async System.Threading.Tasks.Task<MeshOperation> GetMeshOperationAsync (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3")
        {
        ...
        /// <param name="meshingSpecSchemaVersion">Version of the schema the meshing spec should conform to</param>
        /// <returns>Task of ApiResponse (MeshOperation)</returns>
        public async System.Threading.Tasks.Task<SimScale.Sdk.Client.ApiResponse<MeshOperation>> GetMeshOperationAsyncWithHttpInfo (string projectId = default(string), Guid? meshOperationId = default(Guid?), string meshingSpecSchemaVersion = "1.3")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new SimScale.Sdk.Client.ApiException(400, "Missing required parameter 'projectId' when calling MeshOperationsApi->GetMeshOperation");
