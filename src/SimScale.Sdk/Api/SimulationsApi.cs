...
namespace SimScale.Sdk.Api
{
    ...
    public interface ISimulationsApiSync : IApiAccessor
    {
        ...
        SimulationSpec GetSimulation (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0");
        ...
        ApiResponse<SimulationSpec> GetSimulationWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0");
        /// <summary>
    ...
    public interface ISimulationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SimulationSpec> GetSimulationAsync (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0");
        ...
        System.Threading.Tasks.Task<ApiResponse<SimulationSpec>> GetSimulationAsyncWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0");
        /// <summary>
        /// Get Python SDK code for the simulation
        /// </summary>
        /// <remarks>
    ...
    public partial class SimulationsApi : ISimulationsApi
    {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to (optional, default to &quot;12.0&quot;)</param>
        /// <returns>SimulationSpec</returns>
        public SimulationSpec GetSimulation (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0")
        {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to (optional, default to &quot;12.0&quot;)</param>
        /// <returns>ApiResponse of SimulationSpec</returns>
        public SimScale.Sdk.Client.ApiResponse< SimulationSpec > GetSimulationWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to (optional, default to &quot;12.0&quot;)</param>
        /// <returns>Task of SimulationSpec</returns>
        public async System.Threading.Tasks.Task<SimulationSpec> GetSimulationAsync (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0")
        {
        ...
        /// <param name="simulationSpecSchemaVersion">Version of the schema the simulation spec should conform to (optional, default to &quot;12.0&quot;)</param>
        /// <returns>Task of ApiResponse (SimulationSpec)</returns>
        public async System.Threading.Tasks.Task<SimScale.Sdk.Client.ApiResponse<SimulationSpec>> GetSimulationAsyncWithHttpInfo (string projectId = default(string), Guid? simulationId = default(Guid?), string simulationSpecSchemaVersion = "12.0")
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new SimScale.Sdk.Client.ApiException(400, "Missing required parameter 'projectId' when calling SimulationsApi->GetSimulation");
