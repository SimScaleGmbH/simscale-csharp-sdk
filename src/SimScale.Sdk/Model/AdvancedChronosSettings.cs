...
namespace SimScale.Sdk.Model
{
    ...
    public partial class AdvancedChronosSettings : IEquatable<AdvancedChronosSettings>
    {
        ...
        /// <param name="smoother">The algorithm for the prolongation becomes more elaborate from Jacobi over light, medium to heavy FSAI. The stability increases as well as the computational cost. It is recommended to increase it when the problem has distored elements, is ill-conditioned  or has incompressible materials. (default to SmootherEnum.FSAILIGHT).</param>
        ...
        /// <param name="improveTestSpace">This should be enabled only for very complex/ill-conditioned problems, e.g. highly constrained with many BCs, incompressible/hyperelastic materials. (default to false).</param>
        /// <param name="testSpaceIterations">Defaults to 20, can be increased to 50 for complicated cases. (default to 20).</param>
