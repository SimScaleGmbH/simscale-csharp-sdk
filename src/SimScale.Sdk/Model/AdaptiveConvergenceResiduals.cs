...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdaptiveConvergenceResiduals : OneOfResidualsConvergenceMethodConvergenceCriteria, IEquatable<AdaptiveConvergenceResiduals>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveConvergenceResiduals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdaptiveConvergenceResiduals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveConvergenceResiduals" /> class.
        /// </summary>
        /// <param name="type">Schema name: AdaptiveConvergenceResiduals (required) (default to &quot;ADAPTIVE&quot;).</param>
        ...
        public AdaptiveConvergenceResiduals(string type = "ADAPTIVE", decimal? relativeForceTolerance = default(decimal?), DimensionalForce maxResidualForce = default(DimensionalForce), decimal? relativeMomentTolerance = default(decimal?), DimensionalTorque maxResidualMoment = default(DimensionalTorque))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for AdaptiveConvergenceResiduals and cannot be null");
        ...
        /// <summary>
        /// Schema name: AdaptiveConvergenceResiduals
        /// </summary>
        /// <value>Schema name: AdaptiveConvergenceResiduals</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdaptiveConvergenceResiduals {\n");
        ...
        {
            return this.Equals(input as AdaptiveConvergenceResiduals);
        }

        /// <summary>
        /// Returns true if AdaptiveConvergenceResiduals instances are equal
        /// </summary>
        /// <param name="input">Instance of AdaptiveConvergenceResiduals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdaptiveConvergenceResiduals input)
        {
            if (input == null)
                return false;
