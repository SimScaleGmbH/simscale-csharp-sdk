...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubdomainFractionValueInitialCondition : IEquatable<SubdomainFractionValueInitialCondition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubdomainFractionValueInitialCondition" /> class.
        /// </summary>
        ...
        public SubdomainFractionValueInitialCondition(string name = default(string), List<FractionValueInitialCondition> massFractions = default(List<FractionValueInitialCondition>), TopologicalReference topologicalReference = default(TopologicalReference), List<Guid?> geometryPrimitiveUuids = default(List<Guid?>))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubdomainFractionValueInitialCondition {\n");
        ...
        {
            return this.Equals(input as SubdomainFractionValueInitialCondition);
        }

        /// <summary>
        /// Returns true if SubdomainFractionValueInitialCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of SubdomainFractionValueInitialCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubdomainFractionValueInitialCondition input)
        {
            if (input == null)
                return false;
