...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlobalDisplacementType : IEquatable<GlobalDisplacementType>
    {
        /// <summary>
        ...
        protected GlobalDisplacementType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalDisplacementType" /> class.
        /// </summary>
        ...
        public GlobalDisplacementType(string type = "GLOBAL", ComplexNumberEnum? complexNumber = default(ComplexNumberEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GlobalDisplacementType and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalDisplacementType {\n");
        ...
        {
            return this.Equals(input as GlobalDisplacementType);
        }

        /// <summary>
        /// Returns true if GlobalDisplacementType instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalDisplacementType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalDisplacementType input)
        {
            if (input == null)
                return false;
