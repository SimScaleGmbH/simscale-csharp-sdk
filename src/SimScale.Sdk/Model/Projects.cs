...
namespace SimScale.Sdk.Model
{
    ...
    public partial class Projects : IEquatable<Projects>
    {
        ...
        public Projects(CollectionLinks links = default(CollectionLinks), CollectionMeta meta = default(CollectionMeta), List<Project> embedded = default(List<Project>))
        {
            this.Links = links;
            this.Meta = meta;
        ...
        public List<Project> Embedded { get; set; }
