...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutomaticMeshSizingHexDominantSnappy : OneOfHexDominantSnappySizing, IEquatable<AutomaticMeshSizingHexDominantSnappy>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomaticMeshSizingHexDominantSnappy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutomaticMeshSizingHexDominantSnappy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomaticMeshSizingHexDominantSnappy" /> class.
        /// </summary>
        /// <param name="type">Schema name: AutomaticMeshSizingHexDominantSnappy (required) (default to &quot;AUTOMATIC&quot;).</param>
        ...
        public AutomaticMeshSizingHexDominantSnappy(string type = "AUTOMATIC", FinenessEnum? fineness = default(FinenessEnum?))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for AutomaticMeshSizingHexDominantSnappy and cannot be null");
            this.Fineness = fineness;
        }
        
        /// <summary>
        /// Schema name: AutomaticMeshSizingHexDominantSnappy
        /// </summary>
        /// <value>Schema name: AutomaticMeshSizingHexDominantSnappy</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomaticMeshSizingHexDominantSnappy {\n");
        ...
        {
            return this.Equals(input as AutomaticMeshSizingHexDominantSnappy);
        }

        /// <summary>
        /// Returns true if AutomaticMeshSizingHexDominantSnappy instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomaticMeshSizingHexDominantSnappy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomaticMeshSizingHexDominantSnappy input)
        {
            if (input == null)
                return false;
