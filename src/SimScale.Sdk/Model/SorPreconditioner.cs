...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SorPreconditioner : OneOfAdvancedPETSCSettingsPreconditioner, IEquatable<SorPreconditioner>
    {
        /// <summary>
        ...
        public SorPreconditioner(string type = "SOR", RenumberingMethodEnum? renumberingMethod = default(RenumberingMethodEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for SorPreconditioner and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SorPreconditioner {\n");
        ...
        {
            return this.Equals(input as SorPreconditioner);
        }

        /// <summary>
        /// Returns true if SorPreconditioner instances are equal
        /// </summary>
        /// <param name="input">Instance of SorPreconditioner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SorPreconditioner input)
        {
            if (input == null)
                return false;
