...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CadImportRequestOptions : IEquatable<CadImportRequestOptions>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CadImportRequestOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CadImportRequestOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CadImportRequestOptions" /> class.
        /// </summary>
        /// <param name="facetSplit">_Facet Split_ tries to split the faceted parts of a CAD model. This means it can create new faces from original faces. In this case it&#39;s not possible to use the original faces to make assignments.  (required) (default to false).</param>
        ...
        public CadImportRequestOptions(bool? facetSplit = false, bool? sewing = false, bool? improve = true, bool? optimizeForLBMSolver = false)
        {
            // to ensure "facetSplit" is required (not null)
            this.FacetSplit = facetSplit ?? throw new ArgumentNullException("facetSplit is a required property for CadImportRequestOptions and cannot be null");
            // to ensure "sewing" is required (not null)
            this.Sewing = sewing ?? throw new ArgumentNullException("sewing is a required property for CadImportRequestOptions and cannot be null");
            // to ensure "improve" is required (not null)
            this.Improve = improve ?? throw new ArgumentNullException("improve is a required property for CadImportRequestOptions and cannot be null");
            // to ensure "optimizeForLBMSolver" is required (not null)
            this.OptimizeForLBMSolver = optimizeForLBMSolver ?? throw new ArgumentNullException("optimizeForLBMSolver is a required property for CadImportRequestOptions and cannot be null");
        }
        
        /// <summary>
        /// _Facet Split_ tries to split the faceted parts of a CAD model. This means it can create new faces from original faces. In this case it&#39;s not possible to use the original faces to make assignments. 
        /// </summary>
        /// <value>_Facet Split_ tries to split the faceted parts of a CAD model. This means it can create new faces from original faces. In this case it&#39;s not possible to use the original faces to make assignments. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CadImportRequestOptions {\n");
        ...
        {
            return this.Equals(input as CadImportRequestOptions);
        }

        /// <summary>
        /// Returns true if CadImportRequestOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CadImportRequestOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CadImportRequestOptions input)
        {
            if (input == null)
                return false;
