...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NodalForceType : OneOfForceFieldSelectionForceType, IEquatable<NodalForceType>
    {
        /// <summary>
        ...
        public NodalForceType(string type = "NODAL", ComponentSelectionEnum? componentSelection = default(ComponentSelectionEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for NodalForceType and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NodalForceType {\n");
        ...
        {
            return this.Equals(input as NodalForceType);
        }

        /// <summary>
        /// Returns true if NodalForceType instances are equal
        /// </summary>
        /// <param name="input">Instance of NodalForceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodalForceType input)
        {
            if (input == null)
                return false;
