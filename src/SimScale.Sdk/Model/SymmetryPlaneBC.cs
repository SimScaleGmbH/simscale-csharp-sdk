...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymmetryPlaneBC : OneOfDynamicAnalysisBoundaryConditions, OneOfFrequencyAnalysisBoundaryConditions, OneOfHarmonicAnalysisBoundaryConditions, OneOfStaticAnalysisBoundaryConditions, OneOfThermalMechanicalBoundaryConditions, IEquatable<SymmetryPlaneBC>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymmetryPlaneBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SymmetryPlaneBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SymmetryPlaneBC" /> class.
        /// </summary>
        /// <param name="type">This boundary condition restrains the displacement of a face in its normal direction in order to represent a symmetry plane of the structure. Use this boundary condition to reduce the model size significantly if the geometry and the loading conditions are symmetric.&lt;br /&gt;&lt;br /&gt;Important remarks: &lt;br /&gt;&lt;ul&gt;&lt;li&gt;The solver uses linear relations between all three DOFs to constrian the normal movement, thus overcontraint conditions may appear if the edges of the selected faces are constrained by other displacement boundary conditions.&lt;/li&gt;&lt;li&gt;If the assigned faces are orthogonal to a global coordinate axes, it is recommended to directly specifiy the symmetry conditions with a &lt;b&gt;Fixed value&lt;/b&gt; boundary condition.&lt;/li&gt;&lt;/ul&gt;&lt;a href&#x3D; https://www.simscale.com/docs/simulation-setup/boundary-conditions/symmetry/#symmetry-plane-boundary-condition-fea&#39; target&#x3D;&#39;_blank&#39;&gt;Learn more&lt;/a&gt;.  Schema name: SymmetryPlaneBC (required) (default to &quot;SYMMETRY_PLANE&quot;).</param>
        ...
        public SymmetryPlaneBC(string type = "SYMMETRY_PLANE", string name = default(string), TopologicalReference topologicalReference = default(TopologicalReference))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for SymmetryPlaneBC and cannot be null");
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymmetryPlaneBC {\n");
        ...
        {
            return this.Equals(input as SymmetryPlaneBC);
        }

        /// <summary>
        /// Returns true if SymmetryPlaneBC instances are equal
        /// </summary>
        /// <param name="input">Instance of SymmetryPlaneBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymmetryPlaneBC input)
        {
            if (input == null)
                return false;
