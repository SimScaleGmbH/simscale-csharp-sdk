...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TwoResistorNetwork : OneOfAdvancedConceptsThermalResistanceNetworks, IEquatable<TwoResistorNetwork>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoResistorNetwork" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TwoResistorNetwork() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoResistorNetwork" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TwoResistorNetwork {\n");
        ...
        {
            return this.Equals(input as TwoResistorNetwork);
        }

        /// <summary>
        /// Returns true if TwoResistorNetwork instances are equal
        /// </summary>
        /// <param name="input">Instance of TwoResistorNetwork to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TwoResistorNetwork input)
        {
            if (input == null)
                return false;
