...
{
    /// <summary>
    /// DimensionalFunctionVolumetricFlowRate
    /// </summary>
    [DataContract]
    public partial class DimensionalFunctionVolumetricFlowRate : IEquatable<DimensionalFunctionVolumetricFlowRate>
    {
        /// <summary>
        /// Defines Unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DimensionalFunctionVolumetricFlowRate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DimensionalFunctionVolumetricFlowRate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DimensionalFunctionVolumetricFlowRate" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit (required).</param>
        public DimensionalFunctionVolumetricFlowRate(OneOfDimensionalFunctionVolumetricFlowRateValue value = default(OneOfDimensionalFunctionVolumetricFlowRateValue), UnitEnum unit = default(UnitEnum))
        {
            this.Unit = unit;
            this.Value = value;
        }
        ...
        public OneOfDimensionalFunctionVolumetricFlowRateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DimensionalFunctionVolumetricFlowRate {\n");
        ...
        {
            return this.Equals(input as DimensionalFunctionVolumetricFlowRate);
        }

        /// <summary>
        /// Returns true if DimensionalFunctionVolumetricFlowRate instances are equal
        /// </summary>
        /// <param name="input">Instance of DimensionalFunctionVolumetricFlowRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DimensionalFunctionVolumetricFlowRate input)
        {
            if (input == null)
                return false;
