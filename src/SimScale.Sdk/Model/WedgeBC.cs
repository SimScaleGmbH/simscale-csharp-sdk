...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WedgeBC : OneOfCompressibleBoundaryConditions, OneOfConjugateHeatTransferBoundaryConditions, OneOfConvectiveHeatTransferBoundaryConditions, OneOfIncompressibleBoundaryConditions, OneOfMultiphaseBoundaryConditions, IEquatable<WedgeBC>
    {
        /// <summary>
        ...
        public WedgeBC(string type = "WEDGE", string name = default(string), TopologicalReference topologicalReference = default(TopologicalReference))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for WedgeBC and cannot be null");
            this.Name = name;
        ...
        {
            return this.Equals(input as WedgeBC);
        }

        /// <summary>
        /// Returns true if WedgeBC instances are equal
        /// </summary>
        /// <param name="input">Instance of WedgeBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WedgeBC input)
        {
            if (input == null)
                return false;
