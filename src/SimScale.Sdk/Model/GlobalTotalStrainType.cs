...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlobalTotalStrainType : OneOfStrainResultControlItemStrainType, IEquatable<GlobalTotalStrainType>
    {
        /// <summary>
        ...
        protected GlobalTotalStrainType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalTotalStrainType" /> class.
        /// </summary>
        ...
        public GlobalTotalStrainType(string type = "TOTAL", ComplexNumberEnum? complexNumber = default(ComplexNumberEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GlobalTotalStrainType and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalTotalStrainType {\n");
        ...
        {
            return this.Equals(input as GlobalTotalStrainType);
        }

        /// <summary>
        /// Returns true if GlobalTotalStrainType instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalTotalStrainType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalTotalStrainType input)
        {
            if (input == null)
                return false;
