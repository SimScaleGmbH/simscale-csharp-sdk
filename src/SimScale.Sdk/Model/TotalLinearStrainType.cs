...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TotalLinearStrainType : OneOfStrainFieldSelectionStrainType, IEquatable<TotalLinearStrainType>
    {
        /// <summary>
        ...
        protected TotalLinearStrainType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TotalLinearStrainType" /> class.
        /// </summary>
        ...
        public TotalLinearStrainType(string type = "TOTAL_LINEAR", ComponentSelectionEnum? componentSelection = default(ComponentSelectionEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for TotalLinearStrainType and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TotalLinearStrainType {\n");
        ...
        {
            return this.Equals(input as TotalLinearStrainType);
        }

        /// <summary>
        /// Returns true if TotalLinearStrainType instances are equal
        /// </summary>
        /// <param name="input">Instance of TotalLinearStrainType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TotalLinearStrainType input)
        {
            if (input == null)
                return false;
