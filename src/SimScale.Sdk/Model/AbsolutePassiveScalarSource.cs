...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AbsolutePassiveScalarSource : OneOfAdvancedConceptsPassiveScalarSources, IEquatable<AbsolutePassiveScalarSource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbsolutePassiveScalarSource" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AbsolutePassiveScalarSource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AbsolutePassiveScalarSource" /> class.
        /// </summary>
        ...
        public AbsolutePassiveScalarSource(string type = "ABSOLUTE", string name = default(string), string passiveScalarVariable = default(string), DimensionalPassiveScalarSourceRate flux = default(DimensionalPassiveScalarSourceRate), TopologicalReference topologicalReference = default(TopologicalReference), List<Guid?> geometryPrimitiveUuids = default(List<Guid?>))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for AbsolutePassiveScalarSource and cannot be null");
            this.Name = name;
        ...
        public DimensionalPassiveScalarSourceRate Flux { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AbsolutePassiveScalarSource {\n");
        ...
        {
            return this.Equals(input as AbsolutePassiveScalarSource);
        }

        /// <summary>
        /// Returns true if AbsolutePassiveScalarSource instances are equal
        /// </summary>
        /// <param name="input">Instance of AbsolutePassiveScalarSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbsolutePassiveScalarSource input)
        {
            if (input == null)
                return false;
