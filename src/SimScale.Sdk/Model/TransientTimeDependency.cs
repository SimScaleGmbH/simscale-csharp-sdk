...
namespace SimScale.Sdk.Model
{
    ...
    public partial class TransientTimeDependency : OneOfCompressibleTimeDependency, OneOfConjugateHeatTransferTimeDependency, OneOfConvectiveHeatTransferTimeDependency, OneOfCoupledConjugateHeatTransferTimeDependency, OneOfEmbeddedBoundaryTimeDependency, OneOfHeatTransferTimeDependency, OneOfIncompressibleTimeDependency, OneOfSimericsAnalysisTimeDependency, OneOfThermalMechanicalTimeDependency, IEquatable<TransientTimeDependency>
    {
        ...
        protected TransientTimeDependency() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransientTimeDependency" /> class.
        /// </summary>
        /// <param name="type">Schema name: TransientTimeDependency (required) (default to &quot;TRANSIENT&quot;).</param>
        ...
        /// <summary>
        /// Schema name: TransientTimeDependency
        /// </summary>
        /// <value>Schema name: TransientTimeDependency</value>
        ...
        {
            return this.Equals(input as TransientTimeDependency);
        }

        /// <summary>
        /// Returns true if TransientTimeDependency instances are equal
        /// </summary>
        /// <param name="input">Instance of TransientTimeDependency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransientTimeDependency input)
        {
            if (input == null)
                return false;
