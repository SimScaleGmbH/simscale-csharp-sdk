...
namespace SimScale.Sdk.Model
{
    ...
    public partial class BuildingsOfInterest : OneOfPacefishAutomeshPrimaryTopology, OneOfPacefishMeshV38PrimaryTopology, IEquatable<BuildingsOfInterest>
    {
        ...
        public BuildingsOfInterest(string type = "BUILDINGS_OF_INTEREST", TopologicalReference topologicalReference = default(TopologicalReference))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for BuildingsOfInterest and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuildingsOfInterest {\n");
        ...
        {
            return this.Equals(input as BuildingsOfInterest);
        }

        /// <summary>
        /// Returns true if BuildingsOfInterest instances are equal
        /// </summary>
        /// <param name="input">Instance of BuildingsOfInterest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuildingsOfInterest input)
        {
            if (input == null)
                return false;
