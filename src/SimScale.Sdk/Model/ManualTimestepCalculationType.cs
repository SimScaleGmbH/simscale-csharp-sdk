...
namespace SimScale.Sdk.Model
{
    ...
    public partial class ManualTimestepCalculationType : OneOfErrorRetimingEventTimestepCalculationType, OneOfNonMonotomousResidualRetimingEventTimestepCalculationType, IEquatable<ManualTimestepCalculationType>
    {
        ...
        /// <param name="additionalNewtonIterations">&lt;p&gt;Define the percentage of additional Newton Iterations that should be allowed to be used if convergence is not reached after the maximum number of Newton Iterations is reached.&lt;/p&gt; (default to 50M).</param>
