...
namespace SimScale.Sdk.Model
{
    ...
    public partial class StatisticalAveragingResultControlV2 : IEquatable<StatisticalAveragingResultControlV2>
    {
        ...
        public StatisticalAveragingResultControlV2(string type = "STATISTICAL_AVERAGING_V2", decimal? fractionFromEnd = default(decimal?), OneOfStatisticalAveragingResultControlV2SamplingInterval samplingInterval = default(OneOfStatisticalAveragingResultControlV2SamplingInterval), bool? exportFluid = true, bool? exportSurface = false, List<Guid?> geometryPrimitiveUuids = default(List<Guid?>))
        {
            ...
            this.ExportFluid = exportFluid ?? throw new ArgumentNullException("exportFluid is a required property for StatisticalAveragingResultControlV2 and cannot be null");
            // to ensure "exportSurface" is required (not null)
            this.ExportSurface = exportSurface ?? throw new ArgumentNullException("exportSurface is a required property for StatisticalAveragingResultControlV2 and cannot be null");
