...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PerfectGasEquationOfStateEConstThermo : IEquatable<PerfectGasEquationOfStateEConstThermo>
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum SENSIBLEINTERNALENERGY for value: SENSIBLE_INTERNAL_ENERGY
            /// </summary>
            [EnumMember(Value = "SENSIBLE_INTERNAL_ENERGY")]
            SENSIBLEINTERNALENERGY = 1
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PerfectGasEquationOfStateEConstThermo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PerfectGasEquationOfStateEConstThermo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PerfectGasEquationOfStateEConstThermo" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;PERFECT_GAS_E_CONST_THERMO&quot;).</param>
        /// <param name="energy">&lt;p&gt;&lt;b&gt;Energy&lt;/b&gt; provides the methods for the form of energy to be used. The options are:&lt;/p&gt;&lt;p&gt;&lt;b&gt;Sensible enthalpy:&lt;/b&gt; The enthalpy form of equation is used without the heat of formation. In most cases this is the recommended choice.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Sensible internal Energy:&lt;/b&gt; The internal energy form of equation is used without the heat of formation but also incorporates energy change due to reactions.&lt;/p&gt; (default to EnergyEnum.SENSIBLEINTERNALENERGY).</param>
        public PerfectGasEquationOfStateEConstThermo(string type = "PERFECT_GAS_E_CONST_THERMO", EnergyEnum? energy = default(EnergyEnum?))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for PerfectGasEquationOfStateEConstThermo and cannot be null");
            this.Energy = energy;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerfectGasEquationOfStateEConstThermo {\n");
        ...
        {
            return this.Equals(input as PerfectGasEquationOfStateEConstThermo);
        }

        /// <summary>
        /// Returns true if PerfectGasEquationOfStateEConstThermo instances are equal
        /// </summary>
        /// <param name="input">Instance of PerfectGasEquationOfStateEConstThermo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerfectGasEquationOfStateEConstThermo input)
        {
            if (input == null)
                return false;
