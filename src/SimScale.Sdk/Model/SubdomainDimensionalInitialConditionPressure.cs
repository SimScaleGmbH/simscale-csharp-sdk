...
{
    /// <summary>
    /// SubdomainDimensionalInitialConditionPressure
    /// </summary>
    [DataContract]
    public partial class SubdomainDimensionalInitialConditionPressure : IEquatable<SubdomainDimensionalInitialConditionPressure>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubdomainDimensionalInitialConditionPressure" /> class.
        /// </summary>
        ...
        public SubdomainDimensionalInitialConditionPressure(string name = default(string), DimensionalPressure subdomainValue = default(DimensionalPressure), TopologicalReference topologicalReference = default(TopologicalReference), List<Guid?> geometryPrimitiveUuids = default(List<Guid?>))
        {
            this.Name = name;
        ...
        public DimensionalPressure SubdomainValue { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubdomainDimensionalInitialConditionPressure {\n");
        ...
        {
            return this.Equals(input as SubdomainDimensionalInitialConditionPressure);
        }

        /// <summary>
        /// Returns true if SubdomainDimensionalInitialConditionPressure instances are equal
        /// </summary>
        /// <param name="input">Instance of SubdomainDimensionalInitialConditionPressure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubdomainDimensionalInitialConditionPressure input)
        {
            if (input == null)
                return false;
