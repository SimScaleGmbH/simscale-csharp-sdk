...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicAnalysis : Analysis, IEquatable<DynamicAnalysis>
    {
        /// <summary>
        /// Defines MeshOrder
        /// </summary>
        ...
        public List<OneOfDynamicAnalysisConnectionGroups> ConnectionGroups { get; set; }
        ...
        public List<OneOfDynamicAnalysisBoundaryConditions> BoundaryConditions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicAnalysis {\n");
        ...
        {
            return this.Equals(input as DynamicAnalysis);
        }

        /// <summary>
        /// Returns true if DynamicAnalysis instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicAnalysis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicAnalysis input)
        {
            if (input == null)
                return false;
