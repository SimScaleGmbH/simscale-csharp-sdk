...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OscillatingRotatingSBM : OneOfAdvancedConceptsSolidBodyMotions, IEquatable<OscillatingRotatingSBM>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OscillatingRotatingSBM" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OscillatingRotatingSBM() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OscillatingRotatingSBM" /> class.
        /// </summary>
        /// <param name="type">Schema name: OscillatingRotatingSBM (required) (default to &quot;OSCILLATING_ROTATING_MOTION&quot;).</param>
        /// <param name="name">name.</param>
        /// <param name="rotationCenter">rotationCenter.</param>
        /// <param name="amplitude">amplitude.</param>
        /// <param name="angularVelocity">angularVelocity.</param>
        public OscillatingRotatingSBM(string type = "OSCILLATING_ROTATING_MOTION", string name = default(string), DimensionalVectorLength rotationCenter = default(DimensionalVectorLength), DimensionalVectorAngle amplitude = default(DimensionalVectorAngle), DimensionalRotationSpeed angularVelocity = default(DimensionalRotationSpeed))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for OscillatingRotatingSBM and cannot be null");
            this.Name = name;
        ...
        /// <summary>
        /// Schema name: OscillatingRotatingSBM
        /// </summary>
        /// <value>Schema name: OscillatingRotatingSBM</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OscillatingRotatingSBM {\n");
        ...
        {
            return this.Equals(input as OscillatingRotatingSBM);
        }

        /// <summary>
        /// Returns true if OscillatingRotatingSBM instances are equal
        /// </summary>
        /// <param name="input">Instance of OscillatingRotatingSBM to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OscillatingRotatingSBM input)
        {
            if (input == null)
                return false;
