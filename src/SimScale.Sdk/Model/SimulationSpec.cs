...
namespace SimScale.Sdk.Model
{
    ...
    public partial class SimulationSpec : IEquatable<SimulationSpec>
    {
        ...
        /// <param name="version">version (required) (default to &quot;28.0&quot;).</param>
        ...
        public SimulationSpec(string name = default(string), string version = "28.0", Guid? geometryId = default(Guid?), Guid? meshId = default(Guid?), Analysis model = default(Analysis), Dictionary<string, OneOfParameters> parameters = default(Dictionary<string, OneOfParameters>))
        {
