...
namespace SimScale.Sdk.Model
{
    ...
    public partial class SimulationSpec : IEquatable<SimulationSpec>
    {
        ...
        public SimulationSpec(string name = default(string), string version = "6.0", Guid? geometryId = default(Guid?), Guid? meshId = default(Guid?), Analysis model = default(Analysis), Dictionary<string, OneOfParameters> parameters = default(Dictionary<string, OneOfParameters>))
        {
