...
namespace SimScale.Sdk.Model
{
    ...
    public partial class ThinResistanceLayer : OneOfAdvancedConceptsThermalContactResistance, IEquatable<ThinResistanceLayer>
    {
        ...
        public ThinResistanceLayer(string type = "THIN_RESISTANCE_LAYER", string name = default(string), ContactInterfaceMaterialInterfaceThermal interfaceThermal = default(ContactInterfaceMaterialInterfaceThermal), TopologicalReference topologicalReference = default(TopologicalReference))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ThinResistanceLayer and cannot be null");
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThinResistanceLayer {\n");
        ...
        {
            return this.Equals(input as ThinResistanceLayer);
        }

        /// <summary>
        /// Returns true if ThinResistanceLayer instances are equal
        /// </summary>
        /// <param name="input">Instance of ThinResistanceLayer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThinResistanceLayer input)
        {
            if (input == null)
                return false;
