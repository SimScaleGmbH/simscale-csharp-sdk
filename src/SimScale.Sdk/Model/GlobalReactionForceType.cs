...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlobalReactionForceType : OneOfForceResultControlItemForceType, IEquatable<GlobalReactionForceType>
    {
        /// <summary>
        ...
        protected GlobalReactionForceType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalReactionForceType" /> class.
        /// </summary>
        ...
        public GlobalReactionForceType(string type = "REACTION", ComplexNumberEnum? complexNumber = default(ComplexNumberEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GlobalReactionForceType and cannot be null");
            this.ComplexNumber = complexNumber;
        }
        
        /// <summary>
        /// Schema name: GlobalReactionForceType
        /// </summary>
        /// <value>Schema name: GlobalReactionForceType</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalReactionForceType {\n");
        ...
        {
            return this.Equals(input as GlobalReactionForceType);
        }

        /// <summary>
        /// Returns true if GlobalReactionForceType instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalReactionForceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalReactionForceType input)
        {
            if (input == null)
                return false;
