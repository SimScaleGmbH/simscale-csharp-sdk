...
namespace SimScale.Sdk.Model
{
    ...
    public partial class JacobiPreconditioner : OneOfPETSCSolverPreconditioner, IEquatable<JacobiPreconditioner>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JacobiPreconditioner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JacobiPreconditioner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JacobiPreconditioner" /> class.
        /// </summary>
        /// <param name="type">Schema name: JacobiPreconditioner (required) (default to &quot;JACOBI&quot;).</param>
        ...
        public JacobiPreconditioner(string type = "JACOBI", RenumberingMethodEnum? renumberingMethod = default(RenumberingMethodEnum?))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for JacobiPreconditioner and cannot be null");
            this.RenumberingMethod = renumberingMethod;
        }
        
        /// <summary>
        /// Schema name: JacobiPreconditioner
        /// </summary>
        /// <value>Schema name: JacobiPreconditioner</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JacobiPreconditioner {\n");
        ...
        {
            return this.Equals(input as JacobiPreconditioner);
        }

        /// <summary>
        /// Returns true if JacobiPreconditioner instances are equal
        /// </summary>
        /// <param name="input">Instance of JacobiPreconditioner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JacobiPreconditioner input)
        {
            if (input == null)
                return false;
