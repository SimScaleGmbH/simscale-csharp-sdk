...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpeciesHumiditySource : IEquatable<SpeciesHumiditySource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpeciesHumiditySource" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SpeciesHumiditySource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SpeciesHumiditySource" /> class.
        /// </summary>
        ...
        public SpeciesHumiditySource(string type = "SPECIES_MASS_FLOW_RATE", string name = default(string), DimensionalMassFlowRate waterVaporMassRate = default(DimensionalMassFlowRate), DimensionalMassFlowRate dryAirMassRate = default(DimensionalMassFlowRate), TopologicalReference topologicalReference = default(TopologicalReference), List<Guid?> geometryPrimitiveUuids = default(List<Guid?>))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for SpeciesHumiditySource and cannot be null");
            this.Name = name;
        ...
        public DimensionalMassFlowRate WaterVaporMassRate { get; set; }

        /// <summary>
        /// Gets or Sets DryAirMassRate
        /// </summary>
        [DataMember(Name="dryAirMassRate", EmitDefaultValue=false)]
        public DimensionalMassFlowRate DryAirMassRate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpeciesHumiditySource {\n");
        ...
        {
            return this.Equals(input as SpeciesHumiditySource);
        }

        /// <summary>
        /// Returns true if SpeciesHumiditySource instances are equal
        /// </summary>
        /// <param name="input">Instance of SpeciesHumiditySource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpeciesHumiditySource input)
        {
            if (input == null)
                return false;
