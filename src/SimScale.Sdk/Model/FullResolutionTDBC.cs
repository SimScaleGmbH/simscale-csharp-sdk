...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FullResolutionTDBC : OneOfCustomFluidBCTurbulentThermalDiffusivity, IEquatable<FullResolutionTDBC>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FullResolutionTDBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FullResolutionTDBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FullResolutionTDBC" /> class.
        /// </summary>
        ...
        public FullResolutionTDBC(string type = "FULL_RESOLUTION", decimal? prandtlNumber = default(decimal?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for FullResolutionTDBC and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FullResolutionTDBC {\n");
        ...
        {
            return this.Equals(input as FullResolutionTDBC);
        }

        /// <summary>
        /// Returns true if FullResolutionTDBC instances are equal
        /// </summary>
        /// <param name="input">Instance of FullResolutionTDBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FullResolutionTDBC input)
        {
            if (input == null)
                return false;
