...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PointDisplacementBCMarc : OneOfMarcAnalysisBoundaryConditions, IEquatable<PointDisplacementBCMarc>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PointDisplacementBCMarc" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PointDisplacementBCMarc() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PointDisplacementBCMarc" /> class.
        /// </summary>
        /// <param name="type">Schema name: PointDisplacementBCMarc (required) (default to &quot;POINT_DISPLACEMENT&quot;).</param>
        ...
        public PointDisplacementBCMarc(string type = "POINT_DISPLACEMENT", string name = default(string), DimensionalPartialVectorFunctionLength displacement = default(DimensionalPartialVectorFunctionLength), DimensionalPartialVectorFunctionAngle rotation = default(DimensionalPartialVectorFunctionAngle), bool? activateLoadSteps = default(bool?), List<Guid?> loadStepUuids = default(List<Guid?>), List<Guid?> geometryPrimitiveUuids = default(List<Guid?>))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for PointDisplacementBCMarc and cannot be null");
            this.Name = name;
        ...
        /// </summary>
        /// <value>Schema name: PointDisplacementBCMarc</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PointDisplacementBCMarc {\n");
        ...
        {
            return this.Equals(input as PointDisplacementBCMarc);
        }

        /// <summary>
        /// Returns true if PointDisplacementBCMarc instances are equal
        /// </summary>
        /// <param name="input">Instance of PointDisplacementBCMarc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PointDisplacementBCMarc input)
        {
            if (input == null)
                return false;
