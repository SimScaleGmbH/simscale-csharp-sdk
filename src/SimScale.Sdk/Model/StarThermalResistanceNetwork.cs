...
{
    /// <summary>
    /// &lt;br&gt;Apply thermal resistance network modelling. Select the top face of the body you want to assign. &lt;p&gt;The models for &lt;b&gt;thermal resistance network&lt;/b&gt; are as follows:&lt;/p&gt;&lt;ul&gt;&lt;li&gt;&lt;b&gt;Star Network Resistance Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board, a board to interface and four side resistances. A power source is assigned to the body.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Two resistor Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board and a board to interface resistance. A power source is assigned to the body.&lt;/li&gt;&lt;/ul&gt;
    /// </summary>
    [DataContract]
    public partial class StarThermalResistanceNetwork : OneOfAdvancedConceptsThermalResistanceNetworks, IEquatable<StarThermalResistanceNetwork>
    {
        ...
        /// Initializes a new instance of the <see cref="StarThermalResistanceNetwork" /> class.
        /// </summary>
        /// <param name="type">&lt;br&gt;Apply thermal resistance network modelling. Select the top face of the body you want to assign. &lt;p&gt;The models for &lt;b&gt;thermal resistance network&lt;/b&gt; are as follows:&lt;/p&gt;&lt;ul&gt;&lt;li&gt;&lt;b&gt;Star Network Resistance Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board, a board to interface and four side resistances. A power source is assigned to the body.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Two resistor Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board and a board to interface resistance. A power source is assigned to the body.&lt;/li&gt;&lt;/ul&gt;  Schema name: StarThermalResistanceNetwork (required) (default to &quot;STAR_NETWORK&quot;).</param>
        ...
        /// <summary>
        /// &lt;br&gt;Apply thermal resistance network modelling. Select the top face of the body you want to assign. &lt;p&gt;The models for &lt;b&gt;thermal resistance network&lt;/b&gt; are as follows:&lt;/p&gt;&lt;ul&gt;&lt;li&gt;&lt;b&gt;Star Network Resistance Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board, a board to interface and four side resistances. A power source is assigned to the body.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Two resistor Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board and a board to interface resistance. A power source is assigned to the body.&lt;/li&gt;&lt;/ul&gt;  Schema name: StarThermalResistanceNetwork
        /// </summary>
        /// <value>&lt;br&gt;Apply thermal resistance network modelling. Select the top face of the body you want to assign. &lt;p&gt;The models for &lt;b&gt;thermal resistance network&lt;/b&gt; are as follows:&lt;/p&gt;&lt;ul&gt;&lt;li&gt;&lt;b&gt;Star Network Resistance Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board, a board to interface and four side resistances. A power source is assigned to the body.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Two resistor Model:&lt;/b&gt; defines a thermal resistance network consisting out of a top, a board and a board to interface resistance. A power source is assigned to the body.&lt;/li&gt;&lt;/ul&gt;  Schema name: StarThermalResistanceNetwork</value>
