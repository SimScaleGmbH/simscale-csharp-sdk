...
namespace SimScale.Sdk.Model
{
    ...
    public partial class GaussLinearUpwindUnlimitedDivergenceScheme : OneOfDivergenceSchemesDivPhiEkp, OneOfDivergenceSchemesDivPhiEnthalpy, OneOfDivergenceSchemesDivPhiEpsilonDissipationRate, OneOfDivergenceSchemesDivPhiInternalEnergy, OneOfDivergenceSchemesDivPhiKineticEnergy, OneOfDivergenceSchemesDivPhiNuTilda, OneOfDivergenceSchemesDivPhiOmegaDissipationRate, OneOfDivergenceSchemesDivPhiPassiveScalar, OneOfDivergenceSchemesDivPhiR, OneOfDivergenceSchemesDivPhiTemperature, OneOfDivergenceSchemesDivPhiTurbulentKineticEnergy, OneOfDivergenceSchemesDivPhiVelocity, OneOfDivergenceSchemesDivPhidPressure, OneOfDivergenceSchemesDivPhivPressure, OneOfDivergenceSchemesDivRhoPhiVelocity, IEquatable<GaussLinearUpwindUnlimitedDivergenceScheme>
    {
        ...
        public GaussLinearUpwindUnlimitedDivergenceScheme(string type = "GAUSS_LINEARUPWIND_UNLIMITED")
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GaussLinearUpwindUnlimitedDivergenceScheme and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GaussLinearUpwindUnlimitedDivergenceScheme {\n");
        ...
        {
            return this.Equals(input as GaussLinearUpwindUnlimitedDivergenceScheme);
        }

        /// <summary>
        /// Returns true if GaussLinearUpwindUnlimitedDivergenceScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of GaussLinearUpwindUnlimitedDivergenceScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GaussLinearUpwindUnlimitedDivergenceScheme input)
        {
            if (input == null)
                return false;
