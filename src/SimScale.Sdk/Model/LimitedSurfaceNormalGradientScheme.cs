...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LimitedSurfaceNormalGradientScheme : OneOfSurfaceNormalGradientSchemesForDefault, OneOfSurfaceNormalGradientSchemesSurfaceNormalGradientPressureRgh, OneOfSurfaceNormalGradientSchemesSurfaceNormalGradientRho, OneOfSurfaceNormalGradientSchemesSurfaceNormalGradientRhok, IEquatable<LimitedSurfaceNormalGradientScheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitedSurfaceNormalGradientScheme" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LimitedSurfaceNormalGradientScheme() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitedSurfaceNormalGradientScheme" /> class.
        /// </summary>
        /// <param name="type">Schema name: LimitedSurfaceNormalGradientScheme (required) (default to &quot;LIMITED&quot;).</param>
        ...
        public LimitedSurfaceNormalGradientScheme(string type = "LIMITED", decimal? limiterCoefficient = default(decimal?))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for LimitedSurfaceNormalGradientScheme and cannot be null");
            this.LimiterCoefficient = limiterCoefficient;
        }
        
        /// <summary>
        /// Schema name: LimitedSurfaceNormalGradientScheme
        /// </summary>
        /// <value>Schema name: LimitedSurfaceNormalGradientScheme</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LimitedSurfaceNormalGradientScheme {\n");
        ...
        {
            return this.Equals(input as LimitedSurfaceNormalGradientScheme);
        }

        /// <summary>
        /// Returns true if LimitedSurfaceNormalGradientScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of LimitedSurfaceNormalGradientScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LimitedSurfaceNormalGradientScheme input)
        {
            if (input == null)
                return false;
