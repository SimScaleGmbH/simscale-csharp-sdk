...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClockTimeWriteControl : OneOfFluidSimulationControlWriteControl, IEquatable<ClockTimeWriteControl>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClockTimeWriteControl" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClockTimeWriteControl() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClockTimeWriteControl" /> class.
        /// </summary>
        ...
        public ClockTimeWriteControl(string type = "CLOCK_TIME", DimensionalTime writeInterval = default(DimensionalTime))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ClockTimeWriteControl and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClockTimeWriteControl {\n");
        ...
        {
            return this.Equals(input as ClockTimeWriteControl);
        }

        /// <summary>
        /// Returns true if ClockTimeWriteControl instances are equal
        /// </summary>
        /// <param name="input">Instance of ClockTimeWriteControl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClockTimeWriteControl input)
        {
            if (input == null)
                return false;
