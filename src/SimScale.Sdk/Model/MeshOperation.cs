...
namespace SimScale.Sdk.Model
{
    ...
    public partial class MeshOperation : IEquatable<MeshOperation>
    {
        ...
        /// <param name="version">version (required) (default to &quot;1.1&quot;).</param>
        ...
        public MeshOperation(string name = default(string), string version = "1.1", Guid? geometryId = default(Guid?), Algorithm model = default(Algorithm), MeshOperationComputeResource computeResource = default(MeshOperationComputeResource), Status? status = default(Status?))
        {
