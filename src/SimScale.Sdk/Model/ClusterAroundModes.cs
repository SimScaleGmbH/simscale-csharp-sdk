...
namespace SimScale.Sdk.Model
{
    ...
    public partial class ClusterAroundModes : OneOfHarmonicResponseControlExcitationFrequencies, IEquatable<ClusterAroundModes>
    {
        ...
        /// <param name="frequenciesPerMode">Specify the number of excitation frequencies to be clustered around each eigenfrequency. The eigenfrequency itself will also be considered when an even number is provided. (default to 5).</param>
        ...
        /// <summary>
        /// Specify the number of excitation frequencies to be clustered around each eigenfrequency. The eigenfrequency itself will also be considered when an even number is provided.
        /// </summary>
        /// <value>Specify the number of excitation frequencies to be clustered around each eigenfrequency. The eigenfrequency itself will also be considered when an even number is provided.</value>
