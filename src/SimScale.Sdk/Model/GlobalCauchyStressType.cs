...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlobalCauchyStressType : OneOfStressResultControlItemStressType, IEquatable<GlobalCauchyStressType>
    {
        /// <summary>
        ...
        protected GlobalCauchyStressType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalCauchyStressType" /> class.
        /// </summary>
        ...
        public GlobalCauchyStressType(string type = "CAUCHY", ComplexNumberEnum? complexNumber = default(ComplexNumberEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GlobalCauchyStressType and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalCauchyStressType {\n");
        ...
        {
            return this.Equals(input as GlobalCauchyStressType);
        }

        /// <summary>
        /// Returns true if GlobalCauchyStressType instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalCauchyStressType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalCauchyStressType input)
        {
            if (input == null)
                return false;
