...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExplicitTimeIntegrationType : OneOfSolidNumericsMechanicalTimeIntegrationType, IEquatable<ExplicitTimeIntegrationType>
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum ACCELERATION for value: ACCELERATION
            /// </summary>
        ...
        protected ExplicitTimeIntegrationType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExplicitTimeIntegrationType" /> class.
        /// </summary>
        ...
        public OneOfExplicitTimeIntegrationTypeScheme Scheme { get; set; }

        /// <summary>
        /// &lt;p&gt;If activated the simulation run is stopped when at some point the Courant-Friedrichs-Lewy (CFL) condition is violated.&lt;/p&gt;
        /// </summary>
        /// <value>&lt;p&gt;If activated the simulation run is stopped when at some point the Courant-Friedrichs-Lewy (CFL) condition is violated.&lt;/p&gt;</value>
        [DataMember(Name="stopOnCFLCriterion", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExplicitTimeIntegrationType {\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  Scheme: ").Append(Scheme).Append("\n");
            sb.Append("  SchemeFormulation: ").Append(SchemeFormulation).Append("\n");
            sb.Append("  StopOnCFLCriterion: ").Append(StopOnCFLCriterion).Append("\n");
        ...
        {
            return this.Equals(input as ExplicitTimeIntegrationType);
        }

        /// <summary>
        /// Returns true if ExplicitTimeIntegrationType instances are equal
        /// </summary>
        /// <param name="input">Instance of ExplicitTimeIntegrationType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExplicitTimeIntegrationType input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StopOnCFLCriterion == input.StopOnCFLCriterion ||
                    (this.StopOnCFLCriterion != null &&
                    this.StopOnCFLCriterion.Equals(input.StopOnCFLCriterion))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StopOnCFLCriterion != null)
                    hashCode = hashCode * 59 + this.StopOnCFLCriterion.GetHashCode();
