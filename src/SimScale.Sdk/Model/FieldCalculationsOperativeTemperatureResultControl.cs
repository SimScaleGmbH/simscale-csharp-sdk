...
namespace SimScale.Sdk.Model
{
    ...
    public partial class FieldCalculationsOperativeTemperatureResultControl : OneOfFluidResultControlsFieldCalculations, IEquatable<FieldCalculationsOperativeTemperatureResultControl>
    {
        ...
        public FieldCalculationsOperativeTemperatureResultControl(string type = "OPERATIVE_TEMPERATURE", string name = default(string), OperativeTemperatureResultType resultType = default(OperativeTemperatureResultType))
        {
