...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimationOutputSettings : IEquatable<AnimationOutputSettings>
    {
        /// <summary>
        /// Defines Format
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimationOutputSettings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnimationOutputSettings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimationOutputSettings" /> class.
        /// </summary>
        ...
        public AnimationOutputSettings(string name = default(string), FormatEnum format = FormatEnum.GIF, ResolutionInfo resolution = default(ResolutionInfo), int? frameRate = 20, bool? showLegend = true, bool? showCube = true, Color backgroundColor = default(Color))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for AnimationOutputSettings and cannot be null");
            this.Format = format;
            // to ensure "resolution" is required (not null)
            this.Resolution = resolution ?? throw new ArgumentNullException("resolution is a required property for AnimationOutputSettings and cannot be null");
            // to ensure "frameRate" is required (not null)
            this.FrameRate = frameRate ?? throw new ArgumentNullException("frameRate is a required property for AnimationOutputSettings and cannot be null");
            // to ensure "showLegend" is required (not null)
            this.ShowLegend = showLegend ?? throw new ArgumentNullException("showLegend is a required property for AnimationOutputSettings and cannot be null");
            // to ensure "showCube" is required (not null)
            this.ShowCube = showCube ?? throw new ArgumentNullException("showCube is a required property for AnimationOutputSettings and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimationOutputSettings {\n");
        ...
        {
            return this.Equals(input as AnimationOutputSettings);
        }

        /// <summary>
        /// Returns true if AnimationOutputSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimationOutputSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimationOutputSettings input)
        {
            if (input == null)
                return false;
