...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ManualRegionSizingPacefish : OneOfNewRegionRefinementPacefishV38MeshSizing, IEquatable<ManualRegionSizingPacefish>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualRegionSizingPacefish" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManualRegionSizingPacefish() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualRegionSizingPacefish" /> class.
        /// </summary>
        ...
        public ManualRegionSizingPacefish(string type = "MANUAL_REGION_PACEFISH", DimensionalLength targetResolution = default(DimensionalLength))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ManualRegionSizingPacefish and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManualRegionSizingPacefish {\n");
        ...
        {
            return this.Equals(input as ManualRegionSizingPacefish);
        }

        /// <summary>
        /// Returns true if ManualRegionSizingPacefish instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualRegionSizingPacefish to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualRegionSizingPacefish input)
        {
            if (input == null)
                return false;
