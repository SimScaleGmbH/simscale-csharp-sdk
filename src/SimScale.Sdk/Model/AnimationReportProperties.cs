...
namespace SimScale.Sdk.Model
{
    ...
    public partial class AnimationReportProperties : OneOfReportProperties, IEquatable<AnimationReportProperties>
    {
        ...
        protected AnimationReportProperties() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimationReportProperties" /> class.
        /// </summary>
        ...
        public AnimationReportProperties(string reportType = "ANIMATION", ModelSettings modelSettings = default(ModelSettings), Filters filters = default(Filters), OneOfCameraSettings cameraSettings = default(OneOfCameraSettings), OneOfAnimationOutputSettings outputSettings = default(OneOfAnimationOutputSettings))
        {
            // to ensure "reportType" is required (not null)
            this.ReportType = reportType ?? throw new ArgumentNullException("reportType is a required property for AnimationReportProperties and cannot be null");
            // to ensure "modelSettings" is required (not null)
            this.ModelSettings = modelSettings ?? throw new ArgumentNullException("modelSettings is a required property for AnimationReportProperties and cannot be null");
            // to ensure "cameraSettings" is required (not null)
            this.CameraSettings = cameraSettings ?? throw new ArgumentNullException("cameraSettings is a required property for AnimationReportProperties and cannot be null");
            // to ensure "outputSettings" is required (not null)
            this.OutputSettings = outputSettings ?? throw new ArgumentNullException("outputSettings is a required property for AnimationReportProperties and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimationReportProperties {\n");
        ...
        {
            return this.Equals(input as AnimationReportProperties);
        }

        /// <summary>
        /// Returns true if AnimationReportProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimationReportProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimationReportProperties input)
        {
            if (input == null)
                return false;
