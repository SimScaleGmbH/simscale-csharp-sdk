...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocalCartesianBox : GeometryPrimitive, IEquatable<LocalCartesianBox>
    {
        /// <summary>
        ...
        public LocalCartesianBox(string type = "LOCAL_CARTESIAN_BOX", Guid? id = default(Guid?), string name = default(string), OrientationReferenceEnum? orientationReference = default(OrientationReferenceEnum?), DimensionalVectorLength min = default(DimensionalVectorLength), DimensionalVectorLength max = default(DimensionalVectorLength))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for LocalCartesianBox and cannot be null");
            this.Id = id;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocalCartesianBox {\n");
        ...
        {
            return this.Equals(input as LocalCartesianBox);
        }

        /// <summary>
        /// Returns true if LocalCartesianBox instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalCartesianBox to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalCartesianBox input)
        {
            if (input == null)
                return false;
