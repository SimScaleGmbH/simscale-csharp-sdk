...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Folders : IEquatable<Folders>
    {
        /// <summary>
        ...
        public Folders(CollectionLinks links = default(CollectionLinks), CollectionMeta meta = default(CollectionMeta), List<Folder> embedded = default(List<Folder>))
        {
            this.Links = links;
            this.Meta = meta;
        ...
        public List<Folder> Embedded { get; set; }
