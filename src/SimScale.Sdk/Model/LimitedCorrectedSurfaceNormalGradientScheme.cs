...
namespace SimScale.Sdk.Model
{
    ...
    public partial class LimitedCorrectedSurfaceNormalGradientScheme : OneOfSurfaceNormalGradientSchemesForDefault, OneOfSurfaceNormalGradientSchemesSurfaceNormalGradientPressureRgh, OneOfSurfaceNormalGradientSchemesSurfaceNormalGradientRho, OneOfSurfaceNormalGradientSchemesSurfaceNormalGradientRhok, IEquatable<LimitedCorrectedSurfaceNormalGradientScheme>
    {
        ...
        public LimitedCorrectedSurfaceNormalGradientScheme(string type = "LIMITED", decimal? limiterCoefficient = default(decimal?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for LimitedCorrectedSurfaceNormalGradientScheme and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LimitedCorrectedSurfaceNormalGradientScheme {\n");
        ...
        {
            return this.Equals(input as LimitedCorrectedSurfaceNormalGradientScheme);
        }

        /// <summary>
        /// Returns true if LimitedCorrectedSurfaceNormalGradientScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of LimitedCorrectedSurfaceNormalGradientScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LimitedCorrectedSurfaceNormalGradientScheme input)
        {
            if (input == null)
                return false;
