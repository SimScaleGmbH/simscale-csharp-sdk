...
namespace SimScale.Sdk.Model
{
    ...
    public partial class MUMPSSolver : OneOfSolidNumericsSolver, IEquatable<MUMPSSolver>
    {
        ...
        /// Initializes a new instance of the <see cref="MUMPSSolver" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;MUMPS&quot;).</param>
        ...
        /// <param name="preprocessing">If this option is activated MUMPS performs a pre-processing on order to identify the best parameter setting for some internal parameters adapted to the current problem. (required) (default to true).</param>
        ...
        /// <param name="memoryManagement">Choose the memory managment priority of the MUMPS solver. If &lt;b&gt;in-core&lt;/b&gt; is used the memory managment is optimized with respect to the calculation time by saving all objects in the RAM. If &lt;b&gt;out-of-core&lt;/b&gt; is chosen, the memory managment is optimized for a minimal RAM usage. If &lt;b&gt;automatic&lt;/b&gt; is selected, MUMPS choses automatically a reasonable memory managment mode. The option &lt;b&gt;memory demand evaluation&lt;/b&gt; is helpful to estimate the RAM consumption. This estimate is written to the solver log file. In this case the solution process aborts after the memory usage is estimated, allowing the user to start a new run with the best settings. (default to MemoryManagementEnum.INCORE).</param>
        public MUMPSSolver(string type = "MUMPS", bool? forceSymmetric = default(bool?), int? precisionSingularityDetection = default(int?), bool? stopIfSingular = true, MatrixTypeEnum? matrixType = default(MatrixTypeEnum?), decimal? memoryPercentageForPivoting = default(decimal?), decimal? linearSystemRelativeResidual = default(decimal?), decimal? matrixFilteringThreshold = default(decimal?), bool? singlePrecision = default(bool?), bool? preprocessing = true, RenumberingMethodEnum? renumberingMethod = default(RenumberingMethodEnum?), PostprocessingEnum? postprocessing = default(PostprocessingEnum?), bool? distributedMatrixStorage = default(bool?), MemoryManagementEnum? memoryManagement = default(MemoryManagementEnum?))
        {
            ...
            this.StopIfSingular = stopIfSingular ?? throw new ArgumentNullException("stopIfSingular is a required property for MUMPSSolver and cannot be null");
            // to ensure "preprocessing" is required (not null)
            this.Preprocessing = preprocessing ?? throw new ArgumentNullException("preprocessing is a required property for MUMPSSolver and cannot be null");
