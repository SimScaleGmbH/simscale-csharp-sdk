...
{
    /// <summary>
    /// VariableGroupXYZTIME
    /// </summary>
    [DataContract]
    public partial class VariableGroupXYZTIME : IEquatable<VariableGroupXYZTIME>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VariableGroupXYZTIME);
        }

        /// <summary>
        /// Returns true if VariableGroupXYZTIME instances are equal
        /// </summary>
        /// <param name="input">Instance of VariableGroupXYZTIME to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VariableGroupXYZTIME input)
        {
            if (input == null)
                return false;
