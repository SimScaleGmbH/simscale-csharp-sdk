...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DisplacementField : OneOfFieldChangeRetimingEventFieldSelection, IEquatable<DisplacementField>
    {
        /// <summary>
        ...
        public DisplacementField(string type = "DISPLACEMENT", ComponentSelectionEnum? componentSelection = default(ComponentSelectionEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for DisplacementField and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisplacementField {\n");
        ...
        {
            return this.Equals(input as DisplacementField);
        }

        /// <summary>
        /// Returns true if DisplacementField instances are equal
        /// </summary>
        /// <param name="input">Instance of DisplacementField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisplacementField input)
        {
            if (input == null)
                return false;
