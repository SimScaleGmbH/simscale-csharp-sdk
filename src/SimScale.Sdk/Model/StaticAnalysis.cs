...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StaticAnalysis : Analysis, IEquatable<StaticAnalysis>
    {
        /// <summary>
        /// Defines MeshOrder
        /// </summary>
        ...
        public List<OneOfStaticAnalysisConnectors> Connectors { get; set; }
        ...
        public List<OneOfStaticAnalysisBoundaryConditions> BoundaryConditions { get; set; }
        ...
        {
            return this.Equals(input as StaticAnalysis);
        }

        /// <summary>
        /// Returns true if StaticAnalysis instances are equal
        /// </summary>
        /// <param name="input">Instance of StaticAnalysis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaticAnalysis input)
        {
            if (input == null)
                return false;
