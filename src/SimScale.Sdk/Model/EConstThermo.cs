...
namespace SimScale.Sdk.Model
{
    ...
    public partial class EConstThermo : OneOfConstTransportThermo, OneOfSutherlandTransportThermo, IEquatable<EConstThermo>
    {
        ...
        public EConstThermo(string type = "ECONST", DimensionalSpecificHeat specificHeat = default(DimensionalSpecificHeat), PerfectGasEquationOfState equationOfState = default(PerfectGasEquationOfState))
        {
