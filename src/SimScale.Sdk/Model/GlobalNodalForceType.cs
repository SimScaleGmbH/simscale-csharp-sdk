...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlobalNodalForceType : OneOfForceResultControlItemForceType, IEquatable<GlobalNodalForceType>
    {
        /// <summary>
        ...
        protected GlobalNodalForceType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalNodalForceType" /> class.
        /// </summary>
        ...
        public GlobalNodalForceType(string type = "NODAL", ComplexNumberEnum? complexNumber = default(ComplexNumberEnum?))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GlobalNodalForceType and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalNodalForceType {\n");
        ...
        {
            return this.Equals(input as GlobalNodalForceType);
        }

        /// <summary>
        /// Returns true if GlobalNodalForceType instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalNodalForceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalNodalForceType input)
        {
            if (input == null)
                return false;
