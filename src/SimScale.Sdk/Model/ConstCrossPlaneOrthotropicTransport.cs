...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConstCrossPlaneOrthotropicTransport : OneOfSolidCompressibleMaterialTransport, IEquatable<ConstCrossPlaneOrthotropicTransport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstCrossPlaneOrthotropicTransport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstCrossPlaneOrthotropicTransport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstCrossPlaneOrthotropicTransport" /> class.
        /// </summary>
        ...
        public ConstCrossPlaneOrthotropicTransport(string type = "CONST_CROSS_PLANE_ORTHO", CrossPlaneOrthotropicConductivity conductivity = default(CrossPlaneOrthotropicConductivity), OneOfConstCrossPlaneOrthotropicTransportOrientation orientation = default(OneOfConstCrossPlaneOrthotropicTransportOrientation), HConstThermo thermo = default(HConstThermo))
        {
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ConstCrossPlaneOrthotropicTransport and cannot be null");
        ...
        public CrossPlaneOrthotropicConductivity Conductivity { get; set; }

        /// <summary>
        /// Gets or Sets Orientation
        /// </summary>
        [DataMember(Name="orientation", EmitDefaultValue=false)]
        public OneOfConstCrossPlaneOrthotropicTransportOrientation Orientation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConstCrossPlaneOrthotropicTransport {\n");
        ...
        {
            return this.Equals(input as ConstCrossPlaneOrthotropicTransport);
        }

        /// <summary>
        /// Returns true if ConstCrossPlaneOrthotropicTransport instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstCrossPlaneOrthotropicTransport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstCrossPlaneOrthotropicTransport input)
        {
            if (input == null)
                return false;
