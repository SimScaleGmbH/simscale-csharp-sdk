...
namespace SimScale.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VelocityFieldSelection : OneOfAverageFieldsCalculationResultControlItemFieldSelection, OneOfHarmonicResponseResultControlItemFieldSelection, OneOfMinMaxFieldsCalculationResultControlItemFieldSelection, OneOfTemporalResponseResultControlItemFieldSelection, IEquatable<VelocityFieldSelection>
    {
        /// <summary>
        ...
        protected VelocityFieldSelection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VelocityFieldSelection" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as VelocityFieldSelection);
        }

        /// <summary>
        /// Returns true if VelocityFieldSelection instances are equal
        /// </summary>
        /// <param name="input">Instance of VelocityFieldSelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VelocityFieldSelection input)
        {
            if (input == null)
                return false;
