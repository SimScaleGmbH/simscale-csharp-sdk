...
class SandboxExample
{
    static void Main(string[] args)
    {
        ...
        // Verify deserialization of oneOf schema (limited support in C#)
        SimulationRunResults results = simulationRunApi.GetSimulationRunResults(PROJECT_ID, SIMULATION_ID, RUN_ID, null, null, SimulationRunResultType.SOLUTIONFIELD, null, null, null, null);
